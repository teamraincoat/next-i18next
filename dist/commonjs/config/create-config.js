...
var createConfig = function createConfig(userConfig) {
  ...
  */
  ...
  var allLanguages = combinedConfig.allLanguages,
      ...
      customNextDir = combinedConfig.customNextDir;
  ...
  if ((0, _utils.isServer)()) {
    ...
    */
    ...
    if (customNextDir) {
      publicPrefix = "".concat(customNextDir, "/").concat(publicPrefix);
    }
    /*
    ...
    */
    ...
    if (localePath.startsWith(publicPrefix)) {
      clientLocalePath = localePath.replace(new RegExp("^".concat(publicPrefix)), '');
    }
    /*
